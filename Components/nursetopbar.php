...
<div class="topbar">
    <div class="action" style="display: flex;">
                ...
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    <li>
                        ...
                        <div style="margin: 5px">
                            ...
                            <a style="float: right" href="<?php echo BASEURL . '/Nurse/markRead.php?notID='.$row['notificationID']?>">
                                Mark as read
                            </a>
                        </div>
                    </li>
        ...
        <div class="menu">
            ...
            <ul class="topbarul">
                <li><img src="../images/edit.svg" alt="profile image"><a href="#"><a href="<?php echo BASEURL . '/Nurse/updateNurseProfile.php' ?>">Edit Profile</a></a></li>
